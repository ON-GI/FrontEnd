...
const MatchingResultCoordinateComplete = () => {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-white">
      ...
      <p className="mt-6 text-lg font-semibold text-gray-900">요청 내용이 전송되었습니다</p>
...
export default MatchingResultCoordinateComplete;
