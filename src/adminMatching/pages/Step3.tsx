    ...
    <div className="mx-auto mt-6 w-full max-w-md px-6">
      ...
      <div className="mt-6 rounded-lg bg-gray-100 p-4 shadow">
        <p className="text-sm text-gray-700">
          <span className="font-semibold">설정 근무 시간</span> <br />
          월요일 09:00 ~ 10:00 <br />
          월요일 13:00 ~ 14:00
        </p>
        <p className="mt-2 text-sm text-gray-700">
          <span className="font-semibold">케어 시작일 (선택)</span> 없음
        </p>
        <p className="mt-2 text-sm text-gray-700">
          <span className="font-semibold">케어 종료일 (선택)</span> 2025. 08. 31
        </p>
        <p className="mt-2 text-sm text-gray-700">
          <span className="font-semibold">시급</span> 12,000원
        </p>
        <p className="mt-2 text-sm text-gray-700">
          <span className="font-semibold">예상 월급</span> 300,000원
        </p>
      </div>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white px-6 pt-4 pb-6 shadow-md">
        ...
        <div className="mx-auto mt-6 flex w-full max-w-md gap-2">
          ...
          <button
            ...
            className={`w-2/3 rounded-md px-4 py-3 font-semibold text-white ${
